...
write.csv(as.matrix(corpus.tdm),file=file.path("sentimentAnalysis\\tdm_s9.csv"))
...
write.csv(as.matrix(tdm_neg),file=file.path("sentimentAnalysis\\tdm_s9_neg.csv"))
# find the neutral docs and save the matrix 
tdm_neu<-corpus.tdm[ ,score==0]
write.csv(as.matrix(tdm_neu),file=file.path("sentimentAnalysis\\tdm_s9_neu.csv"))
